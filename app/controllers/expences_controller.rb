class ExpencesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @expence.save
        format.html { redirect_to expences_path, notice: 'Расход успешно добавлен.' }
  ...
  def update
    respond_to do |format|
      if @expence.update(expence_params)
        format.html { redirect_to @expence, notice: 'Расход успешно изменен.' }
  ...
  def destroy
    @expence.destroy
    respond_to do |format|
      format.html { redirect_to expences_url, notice: 'Расход успешно удален.' }
  ...
  private
    ...
    def expence_params
      params.require(:expence).permit(:user_id, :expence, :expence_description, :expence_value)
    end
end
